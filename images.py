...
for root, _, filenames in os.walk(posts_dir):
    for filename in filenames:
        if filename.endswith(".md"):
            ...
            # Step 2: Find all image links in the format ![Image Description](/images/Pasted%20image%20...%20.(png|gif|jpg|jpeg))
            images = re.findall(r'\[\[([^]]*\.(?:png|gif|jpg|jpeg))\]\]', content, flags=re.IGNORECASE)
