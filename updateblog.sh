...
sourcePath="/home/comet/Documents/webb/posts"
destinationPath="/home/comet/Documents/cometblog/content/posts"

# Set GitHub Repo
myrepo="git@github.com:annshrunes/cometblog.git"
...
echo "Deploying to GitHub ${current_branch}..."
if ! git push origin "$current_branch"; then
    echo "Failed to push to ${current_branch} branch."
    exit 1
fi
